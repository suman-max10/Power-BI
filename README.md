...
_Comprehensive view of sales trends by state and order date with time-series analysis_

### Super Store Sales Dashboard

![Super Store Sales Overview](images/superstore_sales_dashboard.png)
_Key performance indicators including sales metrics, profit trends, payment modes, and product category breakdown_
